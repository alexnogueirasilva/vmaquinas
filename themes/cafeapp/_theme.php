...
<div class="app">
    <header class="app_header">
        <h1><a class="icon-coffee transition" href="<?= url("/app"); ?>" title="CaféApp">App</a></h1>
    ...
    <footer class="app_footer">
        <span class="icon-coffee">
            MoneyCoffee - Desenvolvido por DevAction<br>
           <?= date("Y") ?> &copy; DevAction - Todos os direitos reservados
        </span>
    </footer>
