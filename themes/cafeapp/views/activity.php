        ...
        ?>
            <article class="app_launch_item">
                <p class="desc app_invoice_link transition">
                    <a title="<?= $invoice->description; ?>" href="<?= url("/app/chamado/{$invoice->id}"); ?>"><?= str_limit_words(
                                                                                                                    $invoice->description,
                                                                                                                    3,
                ...
                <p class="enrollment">
                    <?php if ($invoice->repeat_when == "fixed") : ?>
                        <span class="app_invoice_link">
                            <a href="<?= url("/app/chamado/{$invoice->invoice_of}"); ?>" class="icon-exchange" title="Controlar Conta Fixa">Fixa</a>
                        </span>
                    <?php elseif ($invoice->repeat_when == 'enrollment') : ?>
                        <span class="app_invoice_link">
                            <a href="<?= url("/app/chamado/{$invoice->invoice_of}"); ?>" title="Controlar Parcelamento"><?= str_pad(
