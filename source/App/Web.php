...
class Web extends Controller
{
    ...
    public function login(?array $data): void
    {
        ...
        if (!empty($data['csrf'])) {
            ...
            if (request_limit("weblogin", 3, "300")) {
                $json['message'] = $this->message->error("Você ja efetuou 3 tentativa, por favor aguarde 5 minutos para acessar.")->render();
                echo json_encode($json);
                return;
            }
            ...
            if ($login) {
                ...
                $json['message'] = $auth->message()->before("Whoops! ")->render();
            }
    ...
    public function forget(?array $data)
    {
        ...
        if (!empty($data['csrf'])) {
            ...
            if (request_repeti("webforget", $data["email"])) {
                $json['message'] = $this->message->error("Whoops ,Você ja tentou esse e-mail antes")->render();
                echo json_encode($json);
                return;
            }
    ...
    public function success($data): void
    {
        ...
        echo $this->view->render("optin", [
            ...
            "track" => (object)[
                "fb" => "Lead",
                "aw" => "AW-1004454832/HFRaCKGIp4UDELCH-94D"
            ]
        ]);
    }
    ...
    public function error(array $data): void
    {
        ...
        switch ($data['errcode']) {
            ...
            default:
                ...
                $error->title = "Whoops. Conteúdo indisponível :/";
